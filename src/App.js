...
const App = () => {
  ...
  const contractAddress = "0x30d95960C7cE13Fb62f861fcADaE7869D19DDCE9";
  ...
  return (
    <div className="mainContainer">
      <div className="dataContainer">
        ...
        {currentAccount && <div className="bio">Wallet Connected!!</div>}
        {/* メッセージボックスを実装*/}
        {currentAccount && (
          <textarea
        ...
        {currentAccount &&
          allWaves
            ...
            .map((wave, index) => {
              return (
                <div key={index} className="historyArea">
